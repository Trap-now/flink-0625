...
public class Flink06_Window_EventTime_Tumbling_WaterMark_ForBounded_Bounded {
        ...
        window.process(new ProcessWindowFunction<WaterSensor, String, String, TimeWindow>() {
            ...
            public void process(String key, Context context, Iterable<WaterSensor> elements, Collector<String> out) throws Exception {
                String msg = "当前key: " + key
                        ...
                        + elements.spliterator().estimateSize() + "条数据 "+"waterMark:"+context.currentWatermark();
                out.collect(msg);
            }
        })
                .print();
