...
public class Flink12_CEP_Project_OrderWatch {
    public static void main(String[] args) throws Exception {
        ...
        PatternStream<OrderEvent> result = CEP.pattern(keyedStream, pattern);

        SingleOutputStreamOperator<String> selectResult = result.select(new OutputTag<String>("ouput") {
                                                                  },
        ...
        selectResult.getSideOutput(new OutputTag<String>("ouput") {
        }).print("超时");
